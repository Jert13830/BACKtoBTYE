...
CREATE TABLE `Article` (
    ...
    INDEX `Article_id_categorie_fkey`(`id_categorie`),
    INDEX `Article_id_ordinateur_fkey`(`id_ordinateur`),
    INDEX `Article_id_utilisateur_fkey`(`id_utilisateur`),
...
CREATE TABLE `ArticleLike` (
    ...
    INDEX `ArticleLike_id_article_fkey`(`id_article`),
    INDEX `ArticleLike_id_utilisateur_fkey`(`id_utilisateur`),
...
CREATE TABLE `Commentaire` (
    ...
    INDEX `Commentaire_id_article_fkey`(`id_article`),
    INDEX `Commentaire_id_utilisateur_fkey`(`id_utilisateur`),
...
CREATE TABLE `Emulateur` (
    ...
    INDEX `Emulateur_id_fab_emulateur_fkey`(`id_fab_emulateur`),
    INDEX `Emulateur_id_ordinateur_fkey`(`id_ordinateur`),
...
CREATE TABLE `FabricantEmulateur` (
    ...
    UNIQUE INDEX `FabricantEmulateur_nom_key`(`nom`),
...
CREATE TABLE `FabricantLogiciel` (
    ...
    UNIQUE INDEX `FabricantLogiciel_nom_key`(`nom`),
...
CREATE TABLE `FabricantOrdinateur` (
    ...
    UNIQUE INDEX `FabricantOrdinateur_nom_key`(`nom`),
...
CREATE TABLE `Logiciel` (
    ...
    INDEX `Logiciel_id_fab_logiciel_fkey`(`id_fab_logiciel`),
...
CREATE TABLE `Ordinateur` (
    ...
    INDEX `Ordinateur_id_fab_ordinateur_fkey`(`id_fab_ordinateur`),
...
CREATE TABLE `Photo` (
    ...
    INDEX `Photo_id_emulateur_fkey`(`id_emulateur`),
    INDEX `Photo_id_fab_emulateur_fkey`(`id_fab_emulateur`),
    INDEX `Photo_id_fab_logiciel_fkey`(`id_fab_logiciel`),
    INDEX `Photo_id_fab_ordinateur_fkey`(`id_fab_ordinateur`),
    INDEX `Photo_id_logiciel_fkey`(`id_logiciel`),
    INDEX `Photo_id_ordinateur_fkey`(`id_ordinateur`),
...
CREATE TABLE `Popularite` (
    ...
    INDEX `Popularite_id_ordinateur_fkey`(`id_ordinateur`),
    INDEX `Popularite_id_utilisateur_fkey`(`id_utilisateur`),
...
CREATE TABLE `Rarete` (
    ...
    INDEX `Rarete_id_ordinateur_fkey`(`id_ordinateur`),
    INDEX `Rarete_id_utilisateur_fkey`(`id_utilisateur`),
...
CREATE TABLE `RoleUtilisateur` (
    ...
    INDEX `RoleUtilisateur_id_role_fkey`(`id_role`),
    INDEX `RoleUtilisateur_id_utilisateur_fkey`(`id_utilisateur`),
...
CREATE TABLE `Version` (
    ...
    INDEX `Version_id_logiciel_fkey`(`id_logiciel`),
    INDEX `Version_id_ordinateur_fkey`(`id_ordinateur`),
